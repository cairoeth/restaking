...
import { RestakedStake } from "components/dashboard/restaked"
          ...
          <div className="mx-auto max-w-2xl py-28 sm:py-44 lg:py-48">
            ...
            <div className="text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                {`Restaking.wtf allows for any ERC20 to be used to validate, simultaneously, any or all on-chain trust networks. Our mechanism is original, secure, and composable, and we use it to decentralize OP's sequencer and pioneer optimistic L3s on Polygon's zkEVM, Scroll, and Gnosis Chain.`}</p>
